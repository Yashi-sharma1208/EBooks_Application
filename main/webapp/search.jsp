...
<body>
	...
	<div class="container">
		...
		<div class="row p-3">
			...
			List<Book> list1 = bd1.getBookbySearch(str);
			for (Book b : list1) {
			%>
			<div class="col-md-3">
					...
					<div class="card-body text-center">
						...
						<div class="row text-center">
							<a href="viewBook.jsp?id=<%=b.getBookId()%>"
								class="btn btn-success  btn-sm mr-1 ml-1">View</a> <a href=""
								class="btn btn-secondary my-2  mr-1 my-sm-0  borde"> <i
						...
						<div class="row text-center">
							...
							if (user == null) {
							%>
							<a href="login.jsp" class="btn btn-danger  btn-sm mr-1 ml-1">Add</a>
							<%
							} else {
							%>
							<a
								href="cartServlet?bid=<%=b.getBookId()%>&&uid=<%=user.getId()%>"
								class="btn btn-danger  btn-sm mr-1 ml-1">Add</a>
							<%
							}
							%>
							<a href="viewBook.jsp?id=<%=b.getBookId()%>"
								class="btn btn-success  btn-sm mr-1">View</a> <a href=""
								class="btn btn-secondary my-2  mr-1 my-sm-0  borde"> <i
								class="fas fa-rupee-sign"><%=b.getPrice()%></i>
							</a>
						</div>
